...
```csv
path,label,fake_type,is_inswapper,boundary_label,quality_label,source,video_id,identity_id
data/raw/processed_crops/0001_tight.jpg,1,inswapper,1,1,0,inswapper,video_001,person_001
```
...
- Fake faces generated with INSwapper.
